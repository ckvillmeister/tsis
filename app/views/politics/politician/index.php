  ...
  <?php require 'app/views/components/sidebar.php'; ?>
    ...
    <div class="content-wrapper">
        <div class="content-header">
          ...
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">Politician Info</h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="<?php echo ROOT ?>main">Main</a></li>
                <li class="breadcrumb-item active">Politician Info</li>
              </ol>
            </div>
          </div>
        </div>
          ...
          <div class="card">
            ...
            <div class="row shadow-none m-3 rounded">
              <div class="col-lg-12 align-self-center">
                <div class="btn-group">
                  <button class="btn btn-sm btn-primary" id="btn_new_candidate" data-toggle="modal" data-target="#modal_candidate_form"><icon class="fas fa-plus mr-3"></icon>New</button>
            ...
            <div class="row mt-3 mr-0 ml-0 rounded">
              ...
              <div class="col-lg-4">
                <div class="float-right">
                  <button class="btn btn-sm btn-info" id="btn_submit"><icon class="fas fa-thumbs-up mr-2"></icon>Submit</button>
                </div>
              </div>
            </div>
