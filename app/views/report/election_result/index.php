    ...
    <div class="content-wrapper">
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">Election Result</h1>
            </div>
            <div class="col-sm-6">
        ...
        <div class="container-fluid">
          <div class="card">
            ...
            <div class="row p-3 shadow-none m-3">
              ...
              <div class="col-lg-5">
                <button class="btn btn-sm btn-primary" id="btn_election_results"><icon class="fas fa-thumbs-up mr-2"></icon>Submit</button>
              </div>
              <!--<div class="col-lg-2">
