          ...
          <div class="card">
            ...
            <div class="card card-primary card-outline m-3">
              <div class="card-body box-profile">
                ...
                <div class="row">
                  <div class="col-sm-12">
                    <button class="btn btn-sm btn-success" id="btn_new_record"><i class="fas fa-plus mr-2"></i>Add New Record</button>
                    <a class="btn btn-sm btn-primary text-white" href="<?php echo ROOT; ?>candidates/profile?id=<?php echo $_GET['id']; ?>&status=1"><i class="fas fa-check mr-2"></i>Active</a>
                    <a class="btn btn-sm btn-danger text-white" href="<?php echo ROOT; ?>candidates/profile?id=<?php echo $_GET['id']; ?>&status=0"><i class="fas fa-trash mr-2"></i>Trash</a>
                  </div>
                </div>
                <br>
                <div>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="text-center">
                          ...
                          ?>
                          <input type="hidden" id="text_position" value="<?php echo $result['position']; ?>">
                          <input type="hidden" id="text_level" value="<?php echo $result['level']; ?>">
                          <input type="hidden" id="text_party" value="<?php echo $result['party']; ?>">
                        </td>
                      </tr>
                    <?php
                      }
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="row mt-3">
          ...
          <div class="col-lg-8">
              <input type="number" class="form-control form-control-sm" id="text_year">
          </div>
        </div>
        ...
        <div class="row mt-3 mr-0 ml-0 p-2 bg-light rounded">
          ...
          <div class="col-lg-4">
            <div class="float-right">
              <button class="btn btn-sm btn-success" value="<?php echo isset($_GET['id']) ? $_GET['id'] : ""; ?>" id="btn_add_vote_record"><icon class="fas fa-thumbs-up mr-2"></icon>Submit</button>
            </div>
          </div>
        </div>
